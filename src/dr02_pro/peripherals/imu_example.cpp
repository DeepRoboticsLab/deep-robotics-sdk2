...
public:
    ImuSubscriber() : Node("imu_example") {
        head_imu_sub_ = create_subscription<sensor_msgs::msg::Imu>(
            "/IMU_DATA_HEAD", 10, std::bind(&ImuSubscriber::HandleHeadImuData, this, std::placeholders::_1));
...
private:
     ...
     */
    void HandleHeadImuData(const sensor_msgs::msg::Imu::SharedPtr msg) {
        PrintImu("head", "/IMU_DATA_HEAD", msg);
    }
    ...
    rclcpp::Subscription<sensor_msgs::msg::Imu>::SharedPtr head_imu_sub_;
