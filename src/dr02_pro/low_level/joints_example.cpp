...
constexpr JointArray kDr02Kd{
    ...
    24.0f, 6.0f,  6.0f,   24.0f, 6.0f, 2.0f,       // left leg
    24.0f, 6.0f,  6.0f,   24.0f, 6.0f, 2.0f,       // right leg
    0.0f,  0.0f,                                      // neck
};
...
void PrintUsage(const char* program) {
    std::cerr << "Usage:\n"
              ...
              << "--confirm publishes /JOINTS_CMD and moves all DR02 Pro joints to zero position.\n";
}
